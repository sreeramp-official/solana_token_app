...
export function TokenSelector({ onTokenSelect }: TokenSelectorProps) {
    ...
    return (
        <select
            ...
            className="w-full md:w-auto bg-background border border-input rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-indigo-600 transition-colors m-2"
        >
